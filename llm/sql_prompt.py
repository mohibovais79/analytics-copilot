def get_system_message(db_info: str) -> str:
    prompt = f"""
You are a SQL assistant with access to relational tables. Analyze the user's request and database schema that is provided at the end and respond strictly in JSON format with these keys:
...
- Always follow the database schema provided at the end
